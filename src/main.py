...
@click.option(
    "--quantity", prompt="New quantity", type=int, help="Updated stock quantity"
)
...
def edit_product(sku):
    ...
    if inventory.update_product_details(
        sku, new_name, new_category, new_price, new_description
    ):
